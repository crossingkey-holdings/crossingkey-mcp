...
test('server registers MCP initialize identity',()=>assert.match(source,/name:'crossingkey-mcp',version:'2\.5\.0'/));
...
test('server HTTP discovery surfaces report 2.5.0',()=>{assert.match(source,/version: "2\.5\.0"/); assert.match(source,/version:'2\.5\.0'/);});
