...
export const CAPABILITIES = Object.freeze([
  ...
  {name:'openapi.quality_audit',description:'Deterministically evaluates structural quality and required fields in a supplied OpenAPI document.',priceUsd:'1.00',amount:'1000000'},
...
export function createMachineCommerce(options={}){
  ...
  return {config,status,inspectEntitlement,getPurchase,getReceipt,bindOnchainVerification,verifyReceipt,invoke:args=>withFileLock(config.dataFile,()=>invoke(args)),paymentRequired:(name,v)=>paymentRequired(name,v,config),capabilities:CAPABILITIES};
}
